...
urlpatterns = patterns('',
    ...
    url(r'^blog/pagina-(?P<pagina>\d+)/$', 'blog.views.index', name='blog_pagina'),
    ...
    url(r'^eventos/evento/modificar/$', 'portal.views.modificar_evento' , name='modificar_evento'),
    url(r'^eventos/evento/agregar/$', 'portal.views.agregar_evento' , name='agregar_evento'),
